...
public class RippleSpreadView extends View {
    ...
    private void initView(AttributeSet attrs) {
        ...
        innerColor = typedArray.getColor(R.styleable.RippleSpreadView_rsv_innerCircleColor, Color.parseColor("#882A7AFF"));
        ...
        outColor = typedArray.getColor(R.styleable.RippleSpreadView_rsv_outCircleColor, Color.parseColor("#662A7AFF"));
