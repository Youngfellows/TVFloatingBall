...
public class WaterRippleView extends ImageView {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        int waveColor = typedArray.getColor(R.styleable.WaterRippleView_rippleColor, ContextCompat.getColor(context, R.color.colorPrimary));
        ...
        mRippleSpacing = typedArray.getDimensionPixelSize(R.styleable.WaterRippleView_rippleSpacing, 10);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.i(TAG, "size: " + size + " mWidth: " + mWidth + " mHeight: " + mHeight + " mMaxStrokeWidth: " + mMaxStrokeWidth);
    ...
    private void initArray() {
        for (int i = 0; i < mStrokeWidthArr.length; i++) {
            ...
            Log.i(TAG, "mStrokeWidthArr[" + i + "] = " + mStrokeWidthArr[i]);
        }
    }
    ...
    private void drawRipple(Canvas canvas) {
        for (int strokeWidth : mStrokeWidthArr) {
            ...
            canvas.drawCircle(mWidth / 2, mHeight / 2, mBitmap.getWidth() / 2 + strokeWidth / 2 - 2,
                    mPaint);
        }
